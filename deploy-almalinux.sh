...
# ServiceHub Deploy Script for AlmaLinux 9
# This script sets up and deploys ServiceHub on a fresh AlmaLinux 9 VPS
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}ServiceHub Deploy Script - AlmaLinux 9${NC}"
echo -e "${BLUE}========================================${NC}"
echo
